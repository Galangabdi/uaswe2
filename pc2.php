...
<body>
  ...
  <div class="container max-w-[800px] p-6 bg-white shadow-lg rounded-lg border border-gray-200">
    <div class="product-image">
      <img class="rounded-lg shadow-md" src="https://nguyencongpc.vn/media/product/25488-bts-vip-01-234.jpg" alt="PC Gaming Set">
    </div>
    <div class="product-details">
      <h1 class="product-title text-3xl font-bold text-gray-800 mb-4">PC Gaming Mid-Range</h1>
      <p class="product-price text-2xl font-semibold text-red-500 mb-4">Rp 15.000.000</p>
