...
<body>
  ...
  <div class="container max-w-[800px] p-6 bg-white shadow-lg rounded-lg border border-gray-200">
    <div class="product-image">
      <img class="rounded-lg shadow-md" src="https://breunor.com/cdn/shop/files/PC_Gaming_i7_14700K_RX_7900XTX_24GB_Ram_32Gb_DDR5_6000MHz_SSD_NVMe_2000GB_Dissipatore_a_liquido_240mm_Windows_11.png?v=1741018321" alt="PC Gaming Set">
    </div>
    <div class="product-details">
      <h1 class="product-title text-3xl font-bold text-gray-800 mb-4">PC Standar</h1>
      <p class="product-price text-2xl font-semibold text-red-500 mb-4">Rp 8.000.000</p>
  ...
  <footer class="bg-black text-white px-4 py-3 flex justify-between items-center mt-8">
    <div class="text-2xl font-bold">RED DRAGON</div>
    <nav class="space-x-4 hidden md:block">
      <a href="UTS.html" class="hover:underline">Beranda</a>
      <a href="tentangkami.php" class="hover:underline">tentang kami</a>
      <a href="komponen.html" class="hover:underline">komponen</a>
